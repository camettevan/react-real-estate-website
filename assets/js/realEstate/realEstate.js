...
class App extends Component {
  ...
  filteredData() {
    ...
    if(this.state.elevators == true) {
      newData = newData.filter((item) => {
        return item.extras.elevators == this.state.elevators
      })
    }

    if(this.state.swimming_pool == true){
      newData = newData.filter((item) =>{
        return item.extras.swimming_pool == this.state.swimming_pool
      })
    }

    if(this.state.gym == true) {
      newData = newData.filter((item) => {
        return item.extras.gym == this.state.gym
      })
    }

    if(this.state.finished_basement == true){
      newData = newData.filter((item) =>{
        return item.extras.finished_basement == this.state.finished_basement
      })
    }
